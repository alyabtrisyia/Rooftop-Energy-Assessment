...
The easiest way to differentiate between two integers is by using an if–else statement. Since it is not allowed, I used a mathematical formula to determine the larger number without relying on conditional statements.
